"""
Use this script to create required MatchedFrames files, which define the relationship
...
Use of makeMatchedFrames.py:
    python makeMatchedFrames.py path_to_video_folder acquisition_frame_rate num_landmarks
...
Files will be written to a `data` directory in the video folder parent
"""
